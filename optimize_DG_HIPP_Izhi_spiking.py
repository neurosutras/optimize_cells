...
def init_context():
    ...
    exp_i_inj_amp_f_I_0 = np.array([57.5, 58, 60, 65, 70, 75, 80, 85, 90, 95, 100, 105, 110, 115, 117.5, 120])/1000 # nA 

    exp_rate_f_I_0 = np.array([0, 1, 1, 1, 1, 1, 2, 2, 3, 4, 4, 5, 7, 10, 13, 17])/ 0.6  # Hz, from 600 ms current injections
