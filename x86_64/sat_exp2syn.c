...
#define nrn_init _nrn_init__SatExp2Syn
#define _nrn_initial _nrn_initial__SatExp2Syn
#define nrn_cur _nrn_cur__SatExp2Syn
#define _nrn_current _nrn_current__SatExp2Syn
#define nrn_jacob _nrn_jacob__SatExp2Syn
#define nrn_state _nrn_state__SatExp2Syn
#define _net_receive _net_receive__SatExp2Syn 
#define release release__SatExp2Syn 
...
#define g_inf _p[6]
#define g_onset _p[7]
#define g_offset _p[8]
#define tau_onset _p[9]
#define alpha _p[10]
#define beta _p[11]
#define syn_onset _p[12]
#define Dg_onset _p[13]
#define Dg_offset _p[14]
#define v _p[15]
#define _g _p[16]
#define _tsav _p[17]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 6;
 	...
 	ivoc_help("help ?1 SatExp2Syn /Users/wyin/optimize_cells/x86_64/sat_exp2syn.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Shared synaptic conductance with per-stream saturation";
...
{  double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
 ...
 _tsav = t;   if (_lflag == 1. ) {*(_tqitem) = 0;}
 {
   if ( _lflag  == 0.0 ) {
     _args[3] = _args[3] + 1.0 ;
     if (  ! _args[2] ) {
       _args[4] = _args[4] * exp ( - ( t - _args[5] ) / tau_offset ) ;
       _args[5] = t ;
       _args[2] = 1.0 ;
       syn_onset = syn_onset + _args[0] * _args[1] ;
 ...
 g_offset = g_offset - _args[4] * _args[0] * _args[1] ;
     ...
     if ( _lflag  == _args[3] ) {
       _args[4] = g_inf - ( g_inf - _args[4] ) * exp ( - ( t - _args[5] ) / tau_onset ) ;
       _args[5] = t ;
       syn_onset = syn_onset - _args[0] * _args[1] ;
         if (nrn_netrec_state_adjust && !cvode_active_){
    /* discon state adjustment for cnexp case (rate uses no local variable) */
