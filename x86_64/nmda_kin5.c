...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_KIN5 /Users/wyin/optimize_cells/x86_64/nmda_kin5.mod\n");
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = &(Rc) - _p;  _dlist1[0] = &(DRc) - _p;
 _slist1[1] = &(Rb) - _p;  _dlist1[1] = &(DRb) - _p;
 _slist1[2] = &(Ru) - _p;  _dlist1[2] = &(DRu) - _p;
 _slist1[3] = &(Ro) - _p;  _dlist1[3] = &(DRo) - _p;
_first = 0;
}
