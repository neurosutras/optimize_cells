...
#define nrn_init _nrn_init__FacilNMDA
#define _nrn_initial _nrn_initial__FacilNMDA
#define nrn_cur _nrn_cur__FacilNMDA
#define _nrn_current _nrn_current__FacilNMDA
#define nrn_jacob _nrn_jacob__FacilNMDA
#define nrn_state _nrn_state__FacilNMDA
#define _net_receive _net_receive__FacilNMDA 
#define mgblock mgblock__FacilNMDA 
#define release release__FacilNMDA 
...
#define g_inf _p[13]
#define B _p[14]
#define g_onset _p[15]
#define g_offset _p[16]
#define tau_onset _p[17]
#define alpha _p[18]
#define beta _p[19]
#define syn_onset _p[20]
#define Dg_onset _p[21]
#define Dg_offset _p[22]
#define v _p[23]
#define _g _p[24]
#define _tsav _p[25]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 8;
 	...
 	ivoc_help("help ?1 FacilNMDA /Users/wyin/optimize_cells/x86_64/facil_NMDA.mod\n");
...
static int mgblock(_threadargsprotocomma_ double, double);
...
static int  mgblock ( _threadargsprotocomma_ double _lv , double _lvshift ) {
   B = 1. / ( 1. + exp ( gamma * ( - ( _lv - _lvshift ) ) ) * ( mg / Kd ) ) ;
    return 0; }
...
static double _hoc_mgblock(void* _vptr) {
 ...
 _r = 1.;
 mgblock ( _p, _ppvar, _thread, _nt, *getarg(1) , *getarg(2) );
 return(_r);
}
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  ...
  g_onset = g_onset0;
 {
   ...
   syn_onset = 0. ;
   mgblock ( _threadargscomma_ v , vshift ) ;
   }
