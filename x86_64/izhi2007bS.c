...
#define nrn_init _nrn_init__Izhi2007bS
#define _nrn_initial _nrn_initial__Izhi2007bS
#define nrn_cur _nrn_cur__Izhi2007bS
#define _nrn_current _nrn_current__Izhi2007bS
#define nrn_jacob _nrn_jacob__Izhi2007bS
#define nrn_state _nrn_state__Izhi2007bS
#define _net_receive _net_receive__Izhi2007bS 
#define states states__Izhi2007bS 
...
#define derivfunc derivfunc_Izhi2007bS
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Izhi2007bS /Users/wyin/optimize_cells/x86_64/izhi2007bS.mod\n");
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 89 in file izhi2007bS.mod:\n  SOLVE states METHOD euler\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 1; ++_i) {
