...
#ibrun python3 -m nested.optimize --config-file-path='config/optimize_DG_MC_leak_spiking_shortdend_nearzero_sobol_config.yaml' --output-dir=data --label=cell1000000 --export --num_models=30000 --param-gen=Sobol --hot-start --history-file-path=data/20200325_1638_DG_MC_leak_spiking_Sobol_optimization_history.hdf5 --pregen_param_file_path=data/20200325_1638_Sobol_sequence.hdf5 --verbose=2
...
ibrun python3 -m nested.optimize --config-file-path='data/20200422_0849_optimize_DG_MC_leak_spiking_shortdend_resbounds_sobol_config.yaml' --output-dir=data --label=cell1000000 --export --num_models=30240 --param-gen=Sobol --hot-start --history-file-path='data/20200422_0849_DG_MC_leak_spiking_cell1000000_Sobol_optimization_history.hdf5' --pregen_param_file_path='data/20200422_0849_Sobol_sequence.hdf5' --verbose=0 --pop_size=840
