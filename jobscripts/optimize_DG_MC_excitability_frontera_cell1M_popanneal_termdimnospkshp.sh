...
ibrun python3 -m nested.optimize --config-file-path='config/optimize_DG_MC_excitability_shortdendnewtermdimnospkshape_config.yaml' --pop_size=200 --max_iter=50 --path_length=3 --disp --output-dir=data --label=cell1000000 --hot-start --history-file-path='data/20200512_0050_DG_MC_leak_spiking_cell1000000_PopulationAnnealing_optimization_history.hdf5'
