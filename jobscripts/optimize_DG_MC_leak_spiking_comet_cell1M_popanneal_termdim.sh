...
mpirun -ib python3 -m nested.optimize --config-file-path='config/optimize_DG_MC_leak_spiking_shortdendnewtermdim_config.yaml' --pop_size=200 --max_iter=50 --path_length=3 --disp --output-dir=data --label=cell1000000 --export
