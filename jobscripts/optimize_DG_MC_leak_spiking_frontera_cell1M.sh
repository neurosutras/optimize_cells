...
#SBATCH -J optimize_DG_MC_leak_spiking_shortdend_cell1000000_20200115
#SBATCH -o /scratch1/04119/pmoolcha/HDM/optimize_cells/logs/optimize_DG_MC_excitability_cell1000000_20200127.%j.o
#SBATCH -e /scratch1/04119/pmoolcha/HDM/optimize_cells/logs/optimize_DG_MC_excitability_cell1000000_20200127.%j.e
#SBATCH -p normal 
#SBATCH -N 22 -n 1232 
#SBATCH -t 15:00:00
